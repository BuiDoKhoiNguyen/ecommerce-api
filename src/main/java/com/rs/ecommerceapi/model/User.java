...
public class User {
    ...
    public User(Long id, String firstName, String lastName, String password, String email, String role, String mobile, List<Address> addressList, List<PaymentInformation> paymentInformationList, List<Rating> ratings, List<Review> reviews, LocalDateTime createAt) {
        this.id = id;
